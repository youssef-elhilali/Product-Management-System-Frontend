            ...
            <router-link to="/addCategory" class="btn btn-primary me-1" style="display:inline-block;margin-right:10px;">
              ...
              <div class="dropdown" style="display: inline-block">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <button @click="downloadExcel" style="font-weight: normal" class="dropdown-item"><i class="fa-regular fa-file-excel"></i>Excel</button>
                      <button @click="downloadPDF" style="font-weight: normal" class="dropdown-item"><i class="fa-regular fa-file-pdf"></i>PDF</button>
                  </div>
              </div>
          </div>
        </div>
      ...
      getCategories() {
          CategoryService.listCategories( `pageNo=${this.currentPage}&pageSize=${this.pageSize}`, this.search)
              .then((res) => {
                  ...
                  this.totalCategories = res.data.totalItems;
